...
{
  if ((static_cast<u32>(start) >=
           static_cast<u32>(g_main_cp_state.matrix_index_a.PosNormalMtxIdx) * 4 &&
       static_cast<u32>(start) <
           static_cast<u32>(g_main_cp_state.matrix_index_a.PosNormalMtxIdx) * 4 + 12) ||
      (static_cast<u32>(start) >=
           XFMEM_NORMALMATRICES +
               (static_cast<u32>(g_main_cp_state.matrix_index_a.PosNormalMtxIdx) & 31) * 3 &&
       static_cast<u32>(start) <
           XFMEM_NORMALMATRICES +
  ...
  if ((static_cast<u32>(start) >= static_cast<u32>(g_main_cp_state.matrix_index_a.Tex0MtxIdx) * 4 &&
       static_cast<u32>(start) <
           static_cast<u32>(g_main_cp_state.matrix_index_a.Tex0MtxIdx) * 4 + 12) ||
      (static_cast<u32>(start) >= static_cast<u32>(g_main_cp_state.matrix_index_a.Tex1MtxIdx) * 4 &&
       static_cast<u32>(start) <
           static_cast<u32>(g_main_cp_state.matrix_index_a.Tex1MtxIdx) * 4 + 12) ||
      (static_cast<u32>(start) >= static_cast<u32>(g_main_cp_state.matrix_index_a.Tex2MtxIdx) * 4 &&
       static_cast<u32>(start) <
           static_cast<u32>(g_main_cp_state.matrix_index_a.Tex2MtxIdx) * 4 + 12) ||
      (static_cast<u32>(start) >= static_cast<u32>(g_main_cp_state.matrix_index_a.Tex3MtxIdx) * 4 &&
       static_cast<u32>(start) <
           static_cast<u32>(g_main_cp_state.matrix_index_a.Tex3MtxIdx) * 4 + 12))
  {
  ...
  if ((static_cast<u32>(start) >= static_cast<u32>(g_main_cp_state.matrix_index_b.Tex4MtxIdx) * 4 &&
       static_cast<u32>(start) <
           static_cast<u32>(g_main_cp_state.matrix_index_b.Tex4MtxIdx) * 4 + 12) ||
      (static_cast<u32>(start) >= static_cast<u32>(g_main_cp_state.matrix_index_b.Tex5MtxIdx) * 4 &&
       static_cast<u32>(start) <
           static_cast<u32>(g_main_cp_state.matrix_index_b.Tex5MtxIdx) * 4 + 12) ||
      (static_cast<u32>(start) >= static_cast<u32>(g_main_cp_state.matrix_index_b.Tex6MtxIdx) * 4 &&
       static_cast<u32>(start) <
           static_cast<u32>(g_main_cp_state.matrix_index_b.Tex6MtxIdx) * 4 + 12) ||
      (static_cast<u32>(start) >= static_cast<u32>(g_main_cp_state.matrix_index_b.Tex7MtxIdx) * 4 &&
       static_cast<u32>(start) <
           static_cast<u32>(g_main_cp_state.matrix_index_b.Tex7MtxIdx) * 4 + 12))
  {
