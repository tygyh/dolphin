                            ...
                            TextureFormat texformat, std::span<const u8> tlut_, TLUTFormat tlutfmt)
{
  ...
  */
  ...
  case TextureFormat::C4:
  {
    ...
    *reinterpret_cast<u32*>(dst) = DecodePixel_Paletted(pixel, tlutfmt);
  }
  break;
  case TextureFormat::I4:
  {
  ...
  case TextureFormat::IA8:
  {
    ...
    *reinterpret_cast<u32*>(dst) = DecodePixel_IA8(val);
  }
  break;
  case TextureFormat::C14X2:
  {
  ...
  case TextureFormat::RGB565:
  {
    ...
    *reinterpret_cast<u32*>(dst) = DecodePixel_RGB565(Common::swap16(val));
  }
  break;
  case TextureFormat::RGB5A3:
  {
    ...
    *reinterpret_cast<u32*>(dst) = DecodePixel_RGB5A3(Common::swap16(val));
  }
  break;
  case TextureFormat::RGBA8:
  {
  ...
  case TextureFormat::CMPR:
  {
    ...
    *reinterpret_cast<u32*>(dst) = color;
  }
  break;
  case TextureFormat::XFB:
  {
...
void TexDecoder_DecodeXFB(u8* dst, const u8* src, u32 width, u32 height, u32 stride)
{
  ...
  for (u32 y = 0; y < height; y++)
  {
    ...
    for (u32 x = 0; x < width; x += 2)
    {
      ...
      u8 G1 = static_cast<u8>(
          std::clamp(static_cast<int>(1.164f * Y1 - 0.392f * U - 0.813f * V), 0, 255));
      ...
      u8 G2 = static_cast<u8>(
          std::clamp(static_cast<int>(1.164f * Y2 - 0.392f * U - 0.813f * V), 0, 255));
